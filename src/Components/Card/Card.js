...
const Card = ({movieDetails}) =>{
	return(
		...
		<div className="tc bg-light-green br3 ma2 dib bw2 shadow-5 movieCardContent" style={{backgroundImage:`url(htps://image.tmdb.org/t/p/w185/${movieDetails.poster_path})`,overflow:'hidden',backgroundSize:'contain'}}>
